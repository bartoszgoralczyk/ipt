...
class mysqldriver extends abstractdbdriver
{
   public function __construct($dbinfo)
   {
      ...
      throw new Exception("Aby nawi¹zaæ po³¹czenie z baz¹ danych MySQL, trzeba
   ...
   public function transBegin()
   {
      ...
      $this->execute('START TRANSACTION'); // W tym miejscu mo¿na u¿yæ równie¿ BEGIN lub BEGIN WORK.
      return TRUE;
   }
